...
function add() {
    ...
    $('#selected' + index).css('background-image', 'url("/Content/resources/images/' + this.id + '@2x.png")');
    $('#selected' + index).click(remove);

    $(this).css('background-image', 'url("/Content/resources/images/Darken.png")');
...
function remove() {
    ...
    divSelected.css('background-image', 'url("/Content/resources/images/Darken@2x.png")');
    divSelected.off('click');

    td.css('background-image', 'url("/Content/resources/images/' + card + '.png")');
